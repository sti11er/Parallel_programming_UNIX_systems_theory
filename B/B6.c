...
solution(int fsm[], unsigned fsm_size)
{
    ...
    printf("int label, state, flag, cache[3];\n");
    printf("unsigned fsm_size = %u;\n", fsm_size);

    printf("int fsm[%u] = {", fsm_size*3);
    for (int i = 0; i < (fsm_size*3); ++i) {
        printf("%d, ", fsm[i]);
    }
    printf("};\n");
    ...
    printf("flag = 1;\n");
    printf("// check cache\n");
    printf("if ((cache[0] == state) && (cache[1] == label)){ \n");
    printf("state = cache[2];\n");
    printf("continue;\n");
    printf("}\n");
    printf("for (size_t i = 0; i < (fsm_size*3); i+=3) {\n");
    printf("if (label != fsm[i+1]) {\n");
    printf("continue;\n");
    printf("}\n");
    printf("if (state == fsm[i]) {\n");
    printf("state = fsm[i+2];\n");
    printf("flag = 0;\n");
    printf("break;\n");
    printf("}\n");
    printf("}\n");
